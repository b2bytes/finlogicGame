...
const CORPUS = [
  ...
  // ═══════════════ CMF FINTEC — REGISTRO PSF + SFA (oficial CMF 2024-2026) ═══════════════
  {
    module: 'ley_fintech_21521',
    regulatoryBody: 'CMF',
    title: 'CMF Fintec — Registro de Prestadores de Servicios Financieros (RPSF)',
    lawReference: 'Ley 21.521 + NCG 502/CMF + NCG 514/CMF',
    sourceUrl: 'https://www.cmfchile.cl/portal/principal/613/w3-propertyvalue-43589.html',
    tags: ['cmf', 'fintec', 'registro_psf', 'inscripcion'],
    content: `La CMF mantiene el Registro de Prestadores de Servicios Financieros (RPSF) de la Ley 21.521 Fintec. Servicios obligados a inscribirse: (1) plataformas de financiamiento colectivo (crowdfunding), (2) sistemas alternativos de transacción, (3) asesoría de inversión, (4) asesoría crediticia, (5) custodia de instrumentos financieros, (6) ruteo de órdenes, (7) intermediación de instrumentos financieros. Inscripción gratuita 100% online vía cmfchile.cl. La autorización es revisada en plazo legal de 60 días hábiles. La operación sin RPSF es infracción grave. El registro público está en cmfchile.cl/institucional/estadisticas/seg_rgpsf.php. Consulta: cualquier ciudadano puede verificar si un prestador está autorizado o no.`,
  },
  {
    module: 'ley_fintech_21521',
    regulatoryBody: 'CMF',
    title: 'Sistema de Finanzas Abiertas (SFA) — Open Finance Chile',
    lawReference: 'Ley 21.521 Título III + NCG 514/2024 CMF',
    sourceUrl: 'https://www.cmfchile.cl/portal/principal/613/w3-propertyvalue-47700.html',
    tags: ['sfa', 'open_finance', 'tpp', 'cmf', 'consentimiento'],
    content: `El Sistema de Finanzas Abiertas (SFA) — Open Finance chileno regulado por la NCG 514 de la CMF (julio 2024) — establece el intercambio estandarizado de información financiera entre instituciones bajo consentimiento expreso del cliente. Actores: (1) Proveedores de Información (bancos, cooperativas, emisores de tarjetas, AGF, corredoras, cajas de compensación), (2) Proveedores de Cuenta (bancos, otros emisores de tarjetas o cuentas vista), (3) Proveedores de Servicios Basados en Información (SBI - terceros autorizados, los TPP), (4) Proveedores de Iniciación de Pagos (PIPs). Implementación gradual hasta julio 2026 (anexo técnico Nº3). Consentimiento expreso, granular, revocable y con duración máxima por defecto. La CMF supervisa estándares de seguridad y disponibilidad mínima.`,
  },
  {
    module: 'open_finance',
    regulatoryBody: 'CMF',
    title: 'SFA — Derechos del cliente Open Finance',
    lawReference: 'Ley 21.521 Art. 27-30 + NCG 514',
    sourceUrl: 'https://www.cmfchile.cl/portal/principal/613/w3-article-103411.html',
    tags: ['sfa', 'open_finance', 'derechos', 'consentimiento'],
    content: `Como cliente bancarizado tienes derecho a: (1) Solicitar a tu banco que comparta tus datos financieros con un TPP autorizado (ej: app de finanzas personales, agregador, fintech crediticia) sin que el banco pueda negarse arbitrariamente; (2) Otorgar consentimiento granular: sólo los datos específicos, sólo para el plazo específico, sólo para la finalidad específica; (3) Revocar el consentimiento en cualquier momento sin costo ni penalización; (4) Ser informado de cada acceso de TPP a tus datos; (5) Iniciar pagos desde tu cuenta vía PIP autorizado sin necesidad de tarjeta intermedia. Las instituciones financieras tradicionales que entreguen servicios Fintec deben comunicar previamente a la CMF (deber establecido feb-2026).`,
  },
  {
    module: 'ncg_502_cmf',
    regulatoryBody: 'CMF',
    title: 'NCG 502 + Manual SFA — Reportería obligatoria',
    lawReference: 'NCG 502 CMF + Manual de Sistema de Información Fintec (ene-2025)',
    sourceUrl: 'https://www.cmfchile.cl/portal/prensa/615/w3-article-89761.html',
    tags: ['ncg_502', 'reporteria', 'cmf', 'manual_fintec'],
    content: `La NCG 502 + el Manual del Sistema de Información Fintec (publicado ene-2025) detallan obligaciones operativas y de reportería para entidades inscritas en el RPSF: estructura de gobierno corporativo (directorio, gerente general, oficial de cumplimiento), políticas escritas de gestión de riesgos (operacional, ciberseguridad, conducta de mercado, lavado de activos), reportes regulatorios trimestrales y anuales en formato XBRL/JSON, capital mínimo según servicio (UF 5.000 a UF 25.000), póliza de responsabilidad civil profesional. Los reportes deben presentarse a través del Sistema de Información Fintec en cmfchile.cl. Incumplimiento sancionable hasta UF 15.000 o suspensión del RPSF.`,
  },
  {
    module: 'ley_fintech_21521',
    regulatoryBody: 'CMF',
    title: 'Asesoría de inversión en redes sociales — Cuándo es servicio regulado',
    lawReference: 'Ley 21.521 + Comunicado CMF jul-2024',
    sourceUrl: 'https://www.cmfchile.cl/portal/prensa/615/w3-article-82812.html',
    tags: ['finfluencer', 'asesoria_inversion', 'redes_sociales', 'cmf'],
    content: `En julio 2024 la CMF informó los parámetros bajo los cuales la difusión de contenidos en redes sociales (TikTok, Instagram, YouTube, X, etc.) se considera "servicio de asesoría de inversión" sujeto a inscripción en el RPSF. Constituye asesoría regulada cuando: (1) hay recomendación específica sobre instrumentos financieros particulares, (2) existe relación contractual o remunerada con el público, (3) se ofrece servicio personalizado o segmentado. La educación financiera general NO requiere inscripción. Operar como "finfluencer" recomendando acciones, criptos o fondos sin estar en el RPSF puede constituir infracción a la Ley 21.521 sancionable por la CMF.`,
  },

  // ═══════════════ LEY 21.719 DATOS PERSONALES — CONTENIDO OFICIAL BCN ═══════════════
  {
    module: 'ley_21719_datos',
    regulatoryBody: 'BCN',
    title: 'Ley 21.719 — Vigencia diferida 1 dic 2026',
    lawReference: 'Ley 21.719 (publicada 13-DIC-2024)',
    sourceUrl: 'https://www.bcn.cl/leychile/navegar?idNorma=1209272',
    tags: ['vigencia', 'ley_21719', 'datos_personales'],
    content: `La Ley 21.719 fue publicada el 13 de diciembre de 2024 y entra en vigencia plena el 1 de diciembre de 2026 (24 meses de vacancia legal). Hasta esa fecha continúa rigiendo la Ley 19.628 sobre Protección de la Vida Privada. La Ley 21.719 modifica integralmente la Ley 19.628 — incluso le cambia el nombre a "LOS DATOS PERSONALES" — y crea la Agencia de Protección de Datos Personales (APDP) como autoridad de control independiente. Última modificación: Ley 21.806 (5-FEB-2026). Aplicación territorial: a todo responsable establecido en Chile, mandatarios que actúen para responsables chilenos, y tratamientos extraterritoriales que ofrezcan bienes/servicios a personas en Chile o monitoreen su comportamiento (efecto extraterritorial tipo GDPR).`,
  },
  {
    module: 'ley_21719_datos',
    regulatoryBody: 'BCN',
    title: 'Ley 21.719 — Definiciones clave: dato personal y dato sensible',
    lawReference: 'Ley 21.719 Art. 2° (modifica Art. 2° Ley 19.628)',
    sourceUrl: 'https://www.bcn.cl/leychile/navegar?idNorma=1209272',
    tags: ['definiciones', 'dato_sensible', 'biometricos'],
    content: `Dato personal: cualquier información vinculada o referida a una persona natural identificada o identificable, directa o indirectamente, mediante identificadores como nombre, RUT, datos físicos, fisiológicos, genéticos, psíquicos, económicos, culturales o sociales. Datos personales sensibles (categorías especiales con protección reforzada): origen étnico o racial, afiliación política, sindical o gremial, situación socioeconómica, convicciones ideológicas o filosóficas, creencias religiosas, datos de salud, perfil biológico humano, datos biométricos, vida sexual, orientación sexual e identidad de género. El tratamiento de datos sensibles requiere consentimiento expreso, libre, informado, específico e inequívoco — no se admite consentimiento tácito ni cláusulas pre-marcadas.`,
  },
  {
    module: 'ley_21719_datos',
    regulatoryBody: 'BCN',
    title: 'Ley 21.719 — Derechos ARCOPOL del titular',
    lawReference: 'Ley 21.719 Art. 4° (incorpora Título II en Ley 19.628)',
    sourceUrl: 'https://www.bcn.cl/leychile/navegar?idNorma=1209272',
    tags: ['arcopol', 'derechos', 'arco', 'portabilidad'],
    content: `La Ley 21.719 consagra siete derechos ARCOPOL irrenunciables del titular: (A) Acceso — saber qué datos tiene la empresa sobre ti, finalidades, destinatarios y origen; (R) Rectificación — corregir datos inexactos, incompletos o desactualizados; (C) Cancelación o supresión — borrar datos cuando no son necesarios o se retira el consentimiento; (O) Oposición — oponerse a tratamientos por motivos legítimos, incluyendo perfilado y marketing; (P) Portabilidad — recibir tus datos en formato estructurado, de uso común y lectura mecánica, y transmitirlos a otro responsable; (B) Bloqueo — suspender temporalmente el tratamiento mientras se resuelve una controversia; (L) No ser objeto de decisiones individuales automatizadas con efectos jurídicos significativos. Los derechos son gratuitos, personales e intransferibles. La empresa NO puede exigir cobro por ejercerlos.`,
  },
  {
    module: 'ley_21719_datos',
    regulatoryBody: 'BCN',
    title: 'Ley 21.719 — Cómo presentar solicitud ARCO paso a paso',
    lawReference: 'Ley 21.719 Art. 12 al 18',
    sourceUrl: 'https://www.bcn.cl/leychile/navegar?idNorma=1209272',
    tags: ['arco', 'solicitud', 'paso_a_paso', 'dpo'],
    content: `Para ejercer un derecho ARCOPOL: (1) Identifica al responsable de datos (la empresa) y a su Delegado de Protección de Datos (DPO); las empresas obligadas deben publicar su contacto en su sitio web. (2) Presenta solicitud escrita (correo, formulario web o carta) indicando: nombre completo, RUT, copia de cédula, derecho que ejerces, datos involucrados y canal de respuesta. (3) La empresa tiene 30 días corridos para responder, prorrogables hasta 30 días adicionales en casos complejos justificadamente. (4) Si la respuesta es negativa o incompleta, o si no responde en plazo, puedes reclamar ante la Agencia de Protección de Datos Personales (APDP) — operativa desde 1-DIC-2026. (5) En paralelo puedes demandar indemnización civil por daño moral y material.`,
  },
  {
    module: 'ley_21719_datos',
    regulatoryBody: 'BCN',
    title: 'Ley 21.719 — Multas y sanciones APDP',
    lawReference: 'Ley 21.719 Art. 35 al 41 (régimen sancionatorio)',
    sourceUrl: 'https://www.bcn.cl/leychile/navegar?idNorma=1209272',
    tags: ['multas', 'apdp', 'sanciones', 'gdpr'],
    content: `La Agencia de Protección de Datos Personales (APDP) puede sancionar al responsable infractor con multas escalonadas: infracciones leves hasta 5.000 UTM, infracciones graves hasta 10.000 UTM, infracciones gravísimas hasta 20.000 UTM o el 4% de los ingresos anuales del infractor (lo que sea mayor) — alineado al estándar GDPR europeo. Constituyen infracciones gravísimas: tratamiento de datos sensibles sin consentimiento, transferencia internacional sin garantías, omisión de notificar brechas de seguridad en 72 horas a la APDP y a los titulares afectados, obstrucción a la fiscalización. La empresa además debe inscribir las sanciones firmes en el Registro Nacional de Sanciones y Cumplimiento.`,
  },
  {
    module: 'ley_21719_datos',
    regulatoryBody: 'BCN',
    title: 'Ley 21.719 — Brecha de seguridad: obligación de notificar',
    lawReference: 'Ley 21.719 Art. 14 quáter',
    sourceUrl: 'https://www.bcn.cl/leychile/navegar?idNorma=1209272',
    tags: ['brecha', 'incidente', 'notificacion', '72_horas'],
    content: `Ante una brecha de seguridad de datos personales (acceso no autorizado, pérdida, alteración o divulgación accidental o ilícita), el responsable debe: (1) Notificar a la APDP dentro de 72 horas desde que tomó conocimiento, indicando naturaleza, datos afectados, número de titulares, consecuencias probables y medidas adoptadas. (2) Notificar a los titulares afectados sin dilación injustificada cuando exista alto riesgo para sus derechos. (3) Documentar todo incidente — incluso los no notificables — con evidencia auditable mínimo 5 años. La omisión o tardanza en notificar constituye infracción gravísima sancionable hasta 20.000 UTM. Si tu banco/empresa sufrió una filtración y no te notificó, puedes denunciar a la APDP.`,
  },
  {
    module: 'ley_21719_datos',
    regulatoryBody: 'BCN',
    title: 'Ley 21.719 — Transferencia internacional de datos',
    lawReference: 'Ley 21.719 Art. 27 al 29',
    sourceUrl: 'https://www.bcn.cl/leychile/navegar?idNorma=1209272',
    tags: ['transferencia_internacional', 'cloud', 'datos'],
