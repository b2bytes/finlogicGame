...
export default function LyaMessage({ role, content, sources, confidence }) {
  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div translate="no" className="notranslate max-w-[88%] sm:max-w-[80%] bg-foreground text-background rounded-3xl rounded-tr-md px-4 sm:px-5 py-3 shadow-soft">
  ...
  return (
    <div className="flex gap-2.5 sm:gap-3">
      ...
      <div translate="no" className="notranslate flex-1 min-w-0 max-w-[88%] sm:max-w-[85%] bg-card border border-border rounded-3xl rounded-tl-md px-4 sm:px-5 py-3 shadow-soft">
        <ReactMarkdown
